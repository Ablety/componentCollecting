export const menus = [
    ...
    {
        key: '/app/bootstrap', title: 'bootstrap', icon: 'star',
        sub: [
            { key: '/app/bootstrap/pricing', title: 'pricing', icon: '', },
            // { key: '/app/bootstrap/advancedTable', title: '高级表格', icon: '', },
            // { key: '/app/bootstrap/asynchronousTable', title: '异步表格', icon: '', },
        ],
    },
];